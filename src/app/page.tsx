        ...
        <div className="flex flex-col items-center justify-center text-white text-center max-w-4xl">
          ...
          <div className="w-full max-w-2xl">
            <div className="relative group">
              <input ref={searchInputRef} type="text" className="w-full p-4 pl-6 pr-32 bg-gray-900 border border-gray-700 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 group-hover:border-gray-600" placeholder="Discover: React, Next.js, PHP Laravel, API Mastery..."/>
              ...
              <div className="absolute right-20 top-1/2 transform -translate-y-1/2 flex items-center gap-1 text-sm text-gray-400">
