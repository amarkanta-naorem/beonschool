          ...
          <div className="flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 xl:p-10 w-full lg:w-1/2 md:bg-gray-800">
            ...
            <div className="w-full max-w-md space-y-4 sm:space-y-5 lg:space-y-6">
              ...
              <div className="flex w-full">
                <select value="+91" disabled className="w-16 sm:w-20 lg:w-24 h-9 sm:h-10 lg:h-11 xl:h-12 rounded-l-lg bg-gray-700 text-white border border-gray-600 focus:outline-none">
